            ...
            <div class="ms-panel-body"  >
              ...
              <label>Idcours</label>
                ...
                <label>Nombre de questions</label>
                  <div class="input-group">
                    <input type="text" name="question_count" class="form-control" id="question_count" placeholder="Entrer le nombre de questions "value="<?PHP echo $question_count ?>">
                      <div class="invalid-feedback">
                      </div>
                  </div>
                  ...
                  <label>Durée</label>
                  <div class="input-group">
                    <input type="text" name="duration" class="form-control" id="duration" placeholder="Entrer la durée "value="<?PHP echo $duration ?>">
                      <div class="invalid-feedback">
                      </div>
                  </div>
...
if (isset($_POST['modifier'])){
  $quiz = new quiz($_POST['Idquiz'],$_POST['Idcours'],$_POST['question_count'],$_POST['duration']);
