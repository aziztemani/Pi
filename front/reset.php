  ...
  <section id="reset" >
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-lg-8 mt-5 mt-lg-0">
           ...
           <input type="text" name="id" class="form-control" id="id" placeholder="Adresse e-mail" required>
            </div>
            <br>
            <div class="col-md-6 form-group">
            ...
            <br>          
            <div class="btn-login"><button type="submit" name="reset_password_submit">Envoyer </button></div><br>
          </form>
